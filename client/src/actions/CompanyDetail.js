...
export const getCompanyDetail = () => dispatch => {
  try {
    return axios
      .get("https://localhost:2001/api/companydetail/all")
      .then(res => {
        dispatch({
          type: COMPANY_DETAIL,
...
export const getCompanyDetailById = id => dispatch => {
  ...
  try {
    return axios
      .get("https://localhost:2001/api/companydetail/" + id)
      .then(res => {
        dispatch({
...
export const getDropDownData = sector => dispatch => {
  ...
  try {
    return axios
      .post("https://localhost:2001/api/dropdown", sector)
      .then(res => {
        dispatch({
          type: GET_DROP_DOWN,
          payload: res.data.data
...
export const getSimilarTable = sector => dispatch => {
  ...
  try {
    return axios
      .post("https://localhost:2001/api/analysis/analysis", sector)
      .then(res => {
        dispatch({
...
export const getOhlcChart = id => dispatch => {
  ...
  try {
    return axios
      .get("https://localhost:2001/companyindices/" + id)
      .then(res => {
...
export const downloadOhlcDataCompany = ohlc => {
  try {
    return axios.get(
      "https://localhost:2001/api/companydetail/downloadohlc/" + ohlc
    );
  } catch (err) {
    console.log(err);
  }
...
export const getCompanyDatesById = (id, yearSelected) => dispatch => {
  ...
  try {
    ...
    if (yearSelected.yearInput !== "All") {
      return axios
        .post(
          "https://localhost:2001/api/companydetail/financial/" + id,
          yearSelected
        )
        .then(res => {
          dispatch({
      ...
      return axios
        .post("https://localhost:2001/api/companydetail/financial/" + id)
        .then(res => {
          dispatch({
            type: COMPANY_DATES_BY_ID,
            payload: res.data.data
...
export const getGaugeCompany1 = ticker => dispatch => {
  ...
  try {
    return axios
      .get("https://localhost:2001/gaugeCompany1/" + ticker)
      .then(res => {
        dispatch(stopLoading());
        dispatch({
...
export const getGaugeCompany2 = ticker => dispatch => {
  ...
  try {
    return axios
      .get("https://localhost:2001/gaugeCompany2/" + ticker)
      .then(res => {
        dispatch(stopLoading());
        dispatch({
...
export const getmonteCarloCompany1 = ticker => dispatch => {
  ...
  try {
    return axios
      .get("https://localhost:2001/monteCarloCompany1/" + ticker)
      .then(res => {
        dispatch(stopLoading());
        dispatch({
...
export const getmonteCarloCompany2 = ticker => dispatch => {
  ...
  try {
    return axios
      .get("https://localhost:2001/monteCarloCompany2/" + ticker)
      .then(res => {
        dispatch(stopLoading());
        dispatch({
...
export const getAssetsCompany1 = ticker => dispatch => {
  ...
  try {
    return axios
      .get("https://localhost:2001/assetsCompany1/" + ticker)
      .then(res => {
        dispatch(stopLoading());
        dispatch({
...
export const getAssetsCompany2 = ticker => dispatch => {
  ...
  try {
    return axios
      .get("https://localhost:2001/assetsCompany2/" + ticker)
      .then(res => {
        dispatch(stopLoading());
        dispatch({
...
export const getVolatility = ticker => dispatch => {
  dispatch(startLoading());
  try {
    return axios.get("https://localhost:2001/voltality/" + ticker).then(res => {
      dispatch(stopLoading());
      dispatch({
        type: VOLATILITY,
...
export const sharePriceComparison = (ticker1, ticker2) => dispatch => {
  ...
  try {
    return axios
      .get("https://localhost:2001/shareprice/" + ticker1 + "/" + ticker2)
      .then(res => {
        dispatch(stopLoading());
        dispatch({
